                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto text-right">
                        ...
                        <p class="text-muted font-weight-bold">Sold Out</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto text-right">
                          ...
                          <small class="text-muted">/People</small>
                          @if ($data['kursi'] < 50)
                            <p class="text-danger" style="margin: 0;"><small>{{ $data['kursi'] }} Seats Available</small></p>
                          @endif
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-12 mb-4">
              <div class="card o-hidden border-0 shadow h-100 py-2">
                <div class="card-body text-center">
                  <h3 class="text-gray-900 font-weight-bold">Tickets Not Available</h3>
                  <p class="text-muted">Change the search with different data.</p>
