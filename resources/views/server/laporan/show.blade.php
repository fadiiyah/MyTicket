      ...
      <div class="card shadow h-100" style="border-top: .25rem solid #4e73df">
        <div class="card-body">
          <div class="row no-gutters align-items-center justify-content-center">
            <div class="col h5 font-weight-bold" style="margin-bottom: 0">Trip Details</div>
            <div class="col-auto">
              <span class="title">
                <div class="title-icon rotate-n-15">
                  <i class="fas fa-ticket-alt"></i>
                </div>
                <div class="title-text ml-1">MyTicket</div>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          ...
          <p style="margin-bottom: 0; margin-top: 5px;">Departure Schedule</p>
        ...
        @if ($data->status == "Belum Bayar" && Auth::user()->level != "Penumpang")
          <div class="card-body">
            <a href="{{ route('pembayaran', $data->id) }}" class="btn btn-warning btn-block btn-sm text-white">Verification</a>
          </div>
        @endif
      </div>
    </div>
