...
<head>
  ...
  <title>MyTicket - @yield('title')</title>
...
<body id="page-top">
  ...
  @else
    ...
    @else
      <div class="bg-gradient-warning" style="height: 160px; border-bottom-left-radius: 50% 20px; border-bottom-right-radius: 50% 20px;">
        <nav class="navbar navbar-expand navbar-light topbar mb-4">
          <div class="container">
            <a class="title" href="{{ url('/') }}">
              ...
              <div class="title-text mx-3">MyTicket</div>
            </a>
            <!-- Topbar Navbar -->
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img class="img-profile rounded-circle" src="{{ asset('img/passenger.png') }}">
                </a>
